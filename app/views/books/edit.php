      ...
      <div class="card-body">
        <form class="validate" method="POST" action="<?php echo URLROOT.'/app/controller/'.$this_controller.'?action=edit'; ?>">
          ...
          <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" placeholder="Enter book title..." name="title" value="<?php echo $data->title ?>" required>
            </div>
            <div class="form-group mb-3">
              <label class="form-label">Author</label>
              <input type="text" class="form-control" placeholder="Enter book author..." name="author" value="<?php echo $data->author ?>" required>
            </div>
            <div class="form-group mb-3">
              <label class="form-label">Publisher</label>
              <input type="text" class="form-control" placeholder="Enter book publisher..." name="publisher" value="<?php echo $data->publisher ?>" required>
            </div>
            <div class="form-group mb-3">
              <label class="form-label">Publication Year</label>
              <input type="text" class="form-control" placeholder="Enter book publication Year..." name="year_published" value="<?php echo $data->year_published ?>" required>
            </div> 
